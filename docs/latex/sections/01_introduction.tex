...
\subsection{Agradecimientos y Fuentes de Datos}
Agradecemos formalmente al desarrollador \textbf{Hasan Yıldırım} por la creación y mantenimiento del repositorio \textit{Open Source} \texttt{exercises-dataset}. Su dataset estructurado en JSON proporciona la base de datos completa de ejercicios, metadatos y elementos multimedia que nutren el sistema de siembra (\textit{seeding}) local offline en nuestra arquitectura de persistencia.
