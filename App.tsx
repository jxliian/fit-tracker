...
const i18n = {
  es: {
    ...
    avatarModalTitle: 'Elige tu FitMoji',
    avatarModalSub: 'Selecciona uno de los 4 avatares de animales FitMojis:',
    lionName: 'León Fuerza',
    bearName: 'Oso Mass',
    pantherName: 'Pantera Agilidad',
    eagleName: 'Águila Élite',
    useInitials: 'Usar Iniciales Predeterminadas',
    changeAvatar: 'Cambiar FitMoji (4 Animales)',
    privacySectionTitle: 'Privacidad, Seguridad y Créditos',
  ...
  en: {
    ...
    noRecords: 'No record',
    avatarModalTitle: 'Choose your FitMoji',
    avatarModalSub: 'Select one of the 4 FitMojis animal avatars:',
    lionName: 'Strength Lion',
    bearName: 'Mass Bear',
    pantherName: 'Agility Panther',
    eagleName: 'Elite Eagle',
    useInitials: 'Use Default Initials',
    changeAvatar: 'Change FitMoji (4 Animals)',
    privacySectionTitle: 'Privacy, Security & Credits',
